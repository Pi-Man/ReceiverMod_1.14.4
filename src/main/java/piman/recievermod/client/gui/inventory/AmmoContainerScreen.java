...
public class AmmoContainerScreen extends ContainerScreen<AmmoContainer> {
    private static final ResourceLocation DISPENSER_GUI_TEXTURES = new ResourceLocation("textures/gui/container/dispenser.png");

    public AmmoContainerScreen(AmmoContainer p_i51093_1_, PlayerInventory p_i51093_2_, ITextComponent p_i51093_3_) {
